...
c
            call rpaexp(rsin,exp,vxp,imvex)
c            print *, 'Fortran exp = ', exp
c            print *, 'Fortran vxp = ', vxp
c
c     correlation in paramagnetic limit
c
...
c
            exc= exp + ecp
            vxc= vxp + vcp
c            print *, 'Fortran ecp = ', ecp
c            print *, 'Fortran vcp = ', vcp
            vpol= zero
c
         else
c
...
c
            call rpaexf(rsin,pol,ex,vx,vxpol,imvex)
c            print *, 'Fortran vx = ', vx
c            print *, 'Fortran vxpol = ', vxpol 
c
c     correlation in paramagnetic limit
c
            call vwncop(x,ecp,vcp)
...
c
c            print *, 'Fortran ecp = ', ecp
c            print *, 'Fortran ecf = ', ecf
c            print *, 'Fortran eca = ', eca

            call vwnmix(pol,ecp,ecf,eca,vcp,vcf,vca,ec,vc,vcpol)
c
c     exchange and correlation
c
c            print *, 'Fortran ec = ', ec
            vcu = vc + vpol
            vcd = vc - vpol
c            print *, 'Fortran Vcu = ', vcu
c            print *, 'Fortran Vcd = ', vcd
            exc= ex + ec
            vxc= vx + vc
            vpol= vxpol + vcpol
c
