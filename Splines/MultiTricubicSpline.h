				 ...
				 Array<double,1> &vals)
{
  ...
  vals = 0.0;
    ...
    bSum = 0.0; 
      cSum = 0.0;
      cSum += c0*F(ix,iy,iz  ,0,Range::all());
      cSum += c1*F(ix,iy,iz+1,0,Range::all());
      cSum += c2*F(ix,iy,iz  ,3,Range::all());
      cSum += c3*F(ix,iy,iz+1,3,Range::all());
    bSum += b0*cSum;

      cSum = 0.0;
      cSum += c0*F(ix,iy+1,iz  ,0,Range::all());
      cSum += c1*F(ix,iy+1,iz+1,0,Range::all());
      cSum += c2*F(ix,iy+1,iz  ,3,Range::all());
      cSum += c3*F(ix,iy+1,iz+1,3,Range::all());
    bSum += b1*cSum;

      cSum = 0.0;
      cSum += c0*F(ix,iy,iz  ,2,Range::all());
      cSum += c1*F(ix,iy,iz+1,2,Range::all());
      cSum += c2*F(ix,iy,iz  ,6,Range::all());
      cSum += c3*F(ix,iy,iz+1,6,Range::all());
    bSum += b2*cSum;

      cSum = 0.0;
      cSum += c0*F(ix,iy+1,iz  ,2,Range::all());
      cSum += c1*F(ix,iy+1,iz+1,2,Range::all());
      cSum += c2*F(ix,iy+1,iz  ,6,Range::all());
      cSum += c3*F(ix,iy+1,iz+1,6,Range::all());
    bSum += b3*cSum;
  vals += a0*bSum;
    ...
    bSum = 0.0; 
      cSum = 0.0;
      cSum += c0*F(ix+1,iy,iz  ,0,Range::all());
      cSum += c1*F(ix+1,iy,iz+1,0,Range::all());
      cSum += c2*F(ix+1,iy,iz  ,3,Range::all());
      cSum += c3*F(ix+1,iy,iz+1,3,Range::all());
    bSum += b0*cSum;

      cSum = 0.0;
      cSum += c0*F(ix+1,iy+1,iz  ,0,Range::all());
      cSum += c1*F(ix+1,iy+1,iz+1,0,Range::all());
      cSum += c2*F(ix+1,iy+1,iz  ,3,Range::all());
      cSum += c3*F(ix+1,iy+1,iz+1,3,Range::all());
    bSum += b1*cSum;

      cSum = 0.0;
      cSum += c0*F(ix+1,iy,iz  ,2,Range::all());
      cSum += c1*F(ix+1,iy,iz+1,2,Range::all());
      cSum += c2*F(ix+1,iy,iz  ,6,Range::all());
      cSum += c3*F(ix+1,iy,iz+1,6,Range::all());
    bSum += b2*cSum;

      cSum = 0.0;
      cSum += c0*F(ix+1,iy+1,iz  ,2,Range::all());
      cSum += c1*F(ix+1,iy+1,iz+1,2,Range::all());
      cSum += c2*F(ix+1,iy+1,iz  ,6,Range::all());
      cSum += c3*F(ix+1,iy+1,iz+1,6,Range::all());
    bSum += b3*cSum;
  vals += a1*bSum;
  ...
  ////////////
    bSum = 0.0; 
      cSum = 0.0;
      cSum += c0*F(ix,iy,iz  ,1,Range::all());
      cSum += c1*F(ix,iy,iz+1,1,Range::all());
      cSum += c2*F(ix,iy,iz  ,5,Range::all());
      cSum += c3*F(ix,iy,iz+1,5,Range::all());
    bSum += b0*cSum;

      cSum = 0.0;
      cSum += c0*F(ix,iy+1,iz  ,1,Range::all());
      cSum += c1*F(ix,iy+1,iz+1,1,Range::all());
      cSum += c2*F(ix,iy+1,iz  ,5,Range::all());
      cSum += c3*F(ix,iy+1,iz+1,5,Range::all());
    bSum += b1*cSum;

      cSum = 0.0;
      cSum += c0*F(ix,iy,iz  ,4,Range::all());
      cSum += c1*F(ix,iy,iz+1,4,Range::all());
      cSum += c2*F(ix,iy,iz  ,7,Range::all());
      cSum += c3*F(ix,iy,iz+1,7,Range::all());
    bSum += b2*cSum;

      cSum = 0.0;
      cSum += c0*F(ix,iy+1,iz  ,4,Range::all());
      cSum += c1*F(ix,iy+1,iz+1,4,Range::all());
      cSum += c2*F(ix,iy+1,iz  ,7,Range::all());
      cSum += c3*F(ix,iy+1,iz+1,7,Range::all());
    bSum += b3*cSum;
  vals += a2*bSum;
  ...
  ////////////
    bSum = 0.0; 
      cSum = 0.0;
      cSum += c0*F(ix+1,iy,iz  ,1,Range::all());
      cSum += c1*F(ix+1,iy,iz+1,1,Range::all());
      cSum += c2*F(ix+1,iy,iz  ,5,Range::all());
      cSum += c3*F(ix+1,iy,iz+1,5,Range::all());
    bSum += b0*cSum;

      cSum = 0.0;
      cSum += c0*F(ix+1,iy+1,iz  ,1,Range::all());
      cSum += c1*F(ix+1,iy+1,iz+1,1,Range::all());
      cSum += c2*F(ix+1,iy+1,iz  ,5,Range::all());
      cSum += c3*F(ix+1,iy+1,iz+1,5,Range::all());
    bSum += b1*cSum;

      cSum = 0.0;
      cSum += c0*F(ix+1,iy,iz  ,4,Range::all());
      cSum += c1*F(ix+1,iy,iz+1,4,Range::all());
      cSum += c2*F(ix+1,iy,iz  ,7,Range::all());
      cSum += c3*F(ix+1,iy,iz+1,7,Range::all());
    bSum += b2*cSum;

    cSum = 0.0;
      cSum += c0*F(ix+1,iy+1,iz  ,4,Range::all());
      cSum += c1*F(ix+1,iy+1,iz+1,4,Range::all());
      cSum += c2*F(ix+1,iy+1,iz  ,7,Range::all());
      cSum += c3*F(ix+1,iy+1,iz+1,7,Range::all());
    bSum += b3*cSum;
    vals += a3*bSum;
