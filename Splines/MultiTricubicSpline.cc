...
void 
MultiTricubicSpline::UpdateX(int source, int dest, int i)
{
  Grid &x = *Xgrid;
...
void
MultiTricubicSpline::UpdateXPeriodic(int source, int dest, int i)
{
  Grid &x = *Xgrid;
  int M = x.NumPoints - 1;
...
void 
MultiTricubicSpline::UpdateY(int source, int dest, int i)
{
  Grid &y = *Ygrid;
...
void
MultiTricubicSpline::UpdateYPeriodic(int source, int dest, int i)
{
  Grid &y = *Ygrid;
  int M = y.NumPoints - 1;
  // Check to make sure first and last point are the same.
...
void
MultiTricubicSpline::UpdateZPeriodic(int source, int dest, int i)
{
  Grid &z = *Zgrid;
  int M = z.NumPoints - 1;
  // Check to make sure first and last point are the same.
