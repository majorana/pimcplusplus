...
public:
  ...
  bool Append (Array<string,3> &strs);
...
public:
  ...
  void WriteVar (string name, Array<double,4> &v);
  ...
  void WriteVar (string name, Array<int,4> &v);
  ...
  void WriteVar (string name, Array<string,4> &v);
  ...
  void WriteVar (string name, Array<bool,4> &v);
};
