...
DEFS = $(EXTRADEFS) -DNDIM=3 -DVERSION=$(VER) -O3 -DNO_COUT -DUSE_MPI #-DBZ_DEBUG #-DDEBUG #-ffast-math#  -DDEBUG -DBZ_DEBUG  # -DUSE_MPI #  DPARALLEL  # -DDEBUG -DBZ_DEBUG  -g #-DUSE_MPI -DTHREE_D 
